...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_mpvue_loader_1_1_2_mpvue_loader_lib_template_compiler_index_id_data_v_a5d44e4c_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_node_modules_mpvue_loader_1_1_2_mpvue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_styles__,
  __vue_scopeId__,
  ...
  methods: {
    ...
    togglePopup: function togglePopup() {
      ...
      if (this.isPopup == true) {
        Object(__WEBPACK_IMPORTED_MODULE_7__utils__["b" /* get */])("coupon/api/personal/PHPSESSID/" + wx.getStorageSync("PHPSESSID")).then(function (res) {
          console.log(res);
    ...
    toggleShopPopup: function toggleShopPopup() {
      ...
      if (this.isShopPopup == true) {
        Object(__WEBPACK_IMPORTED_MODULE_7__utils__["g" /* post */])("shop/api/shop_list", {
    ...
    submitOrder: function submitOrder() {
      ...
      Object(__WEBPACK_IMPORTED_MODULE_7__utils__["g" /* post */])("shop/api/add_order", {
        ...
        if (res.code == 0) {
          Object(__WEBPACK_IMPORTED_MODULE_8__static_vant_toast_toast__["a" /* default */])("支付失败");
        } else {
          Object(__WEBPACK_IMPORTED_MODULE_7__utils__["c" /* goPay */])(res.out_trade_no);
          // 清购物车数量
