...
CREATE TABLE `wp_analysis`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sports_id` int(10) NULL DEFAULT NULL COMMENT 'sports_id',
...
CREATE TABLE `wp_app_category`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `icon` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '分类图标',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类名',
...
) ENGINE = InnoDB AUTO_INCREMENT = 268 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信插件表' ROW_FORMAT = Compact;
...
CREATE TABLE `wp_area`  (
  ...
  `pid` int(10) NULL DEFAULT NULL COMMENT '上级编号',
  `sort` int(10) NULL DEFAULT 0 COMMENT '排序号',
  PRIMARY KEY (`id`) USING BTREE
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户组与分类的对应关系表' ROW_FORMAT = Compact;
...
CREATE TABLE `wp_auth_group`  (
  ...
  `wechat_group_count` int(10) NULL DEFAULT NULL COMMENT '微信端用户数',
...
CREATE TABLE `wp_auth_rule`  (
  ...
  `mod` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'common' COMMENT ' 所属应用/模块，核心系统的规则使用common',
  `type` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'custom_app' COMMENT '规则类型，可能的值有： common_app custom_app wap public_mod public_interface',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `name`(`name`, `mod`) USING BTREE
...
CREATE TABLE `wp_auto_reply`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `video_id` int(10) NULL DEFAULT NULL COMMENT '视频素材id',
  `voice_id` int(10) NULL DEFAULT NULL COMMENT '语音素材id',
  `image_material` int(10) NULL DEFAULT NULL COMMENT '素材图片id',
  `manager_id` int(10) NULL DEFAULT NULL COMMENT '管理员ID',
  `img_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '上传图片',
  `news_id` int(10) NULL DEFAULT NULL COMMENT '图文',
  `msg_type` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'text' COMMENT '消息类型',
...
CREATE TABLE `wp_award`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `img` int(10) NULL DEFAULT NULL COMMENT '奖品图片',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '奖项名称',
  `score` int(10) NULL DEFAULT 0 COMMENT '积分数',
  `award_type` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '奖品类型',
  `price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '商品价格',
  `explain` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '奖品说明',
  ...
  `coupon_id` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '选择赠送券',
  `money` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '现金',
  `aim_table` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动标识',
...
CREATE TABLE `wp_buy_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `pay` float NULL DEFAULT NULL COMMENT '消费金额',
  `sn_id` int(10) NULL DEFAULT NULL COMMENT '优惠卷',
  `pay_type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付方式',
  `branch_id` int(10) NULL DEFAULT 0 COMMENT '消费门店',
  `member_id` int(10) NULL DEFAULT NULL COMMENT '会员卡id',
...
CREATE TABLE `wp_chat`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `to_uid` int(10) NULL DEFAULT NULL COMMENT 'to_uid',
...
CREATE TABLE `wp_collage`  (
  ...
  `cover` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '活动宣传图',
  ...
  `type` tinyint(2) NULL DEFAULT NULL COMMENT '显示类型',
...
CREATE TABLE `wp_collage_group`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '开团用户ID',
  `create_at` int(10) NULL DEFAULT NULL COMMENT '参与时间',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '拼团商品ID',
  `order_count` int(10) NULL DEFAULT NULL COMMENT '拼团人数',
...
CREATE TABLE `wp_collage_order`  (
  ...
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `create_at` int(10) NULL DEFAULT NULL COMMENT '下单时间',
  `sale_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '拼团价格',
...
CREATE TABLE `wp_comment`  (
  ...
  `aim_id` int(10) NULL DEFAULT NULL COMMENT '评论关联ID',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '评论时间',
  `follow_id` int(10) NULL DEFAULT NULL COMMENT 'follow_id',
...
CREATE TABLE `wp_common_category`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类标识',
  ...
  `path` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类路径',
  `module` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分类所属功能',
  `sort` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '排序号',
...
CREATE TABLE `wp_common_category_group`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分组标识',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '分组标题',
  `cTime` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '发布时间',
...
CREATE TABLE `wp_coupon`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `background` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '素材背景图',
  `use_tips` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '使用说明',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `intro` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '封面简介',
  `end_time` int(10) NULL DEFAULT NULL COMMENT '领取结束时间',
  `cover` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '优惠券图片',
  `cTime` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '发布时间',
  `start_time` int(10) NULL DEFAULT NULL COMMENT '开始时间',
  `end_tips` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '领取结束说明',
  `end_img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '领取结束提示图片',
  `num` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '优惠券数量',
  `max_num` int(10) UNSIGNED NULL DEFAULT 1 COMMENT '每人最多允许获取次数',
  `follower_condtion` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '粉丝状态',
  `credit_conditon` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '积分限制',
  `credit_bug` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '积分消费',
  `addon_condition` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '插件场景限制',
  `collect_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '已领取数',
  `view_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '浏览人数',
  `addon` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'public' COMMENT '插件',
  `shop_uid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商家管理员ID',
  `use_count` int(10) NULL DEFAULT 0 COMMENT '已使用数',
  `empty_prize_tips` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '奖品抽完后的提示',
  `start_tips` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动还没开始时的提示语',
  `over_time` int(10) NULL DEFAULT NULL COMMENT '使用的截止时间',
  `use_start_time` int(10) NULL DEFAULT NULL COMMENT '使用开始时间',
  `shop_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '优惠商家' COMMENT '商家名称',
  `shop_logo` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '商家LOGO',
...
CREATE TABLE `wp_credit_cash`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品名称',
  `describe` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品描述',
  `num` int(10) NULL DEFAULT NULL COMMENT '商品个数',
  `img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '商品图片',
  `explain` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '使用说明',
  `fail` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '兑换失败提示',
  `score` int(10) NULL DEFAULT NULL COMMENT '兑换所需积分',
  `surplus` int(10) NULL DEFAULT NULL COMMENT '剩余',
...
CREATE TABLE `wp_credit_config`  (
  ...
  `mod` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'common' COMMENT '应用英文名，核心功能默认为common',
...
CREATE TABLE `wp_custom_reply_news`  (
  ...
  `cover` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '封面图片',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '内容',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '发布时间',
  `sort` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '排序号',
...
CREATE TABLE `wp_custom_sendall`  (
  ...
  `is_send` int(10) NULL DEFAULT NULL COMMENT '是否已经发送',
  `uid` int(10) NULL DEFAULT NULL COMMENT '粉丝uid',
  ...
  `voice_id` int(10) NULL DEFAULT NULL COMMENT '语音id',
  `image_id` int(10) NULL DEFAULT NULL COMMENT '图片id',
  `video_id` int(10) NULL DEFAULT NULL COMMENT '视频id',
  `send_type` int(10) NULL DEFAULT NULL COMMENT '发送方式',
...
CREATE TABLE `wp_draw_follow_log`  (
  ...
  `sports_id` int(10) NULL DEFAULT NULL COMMENT '场次id',
  `count` int(10) NULL DEFAULT 0 COMMENT '抽奖次数',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '支持时间',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `wp_draw_pv_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '访问时间',
  `draw_id` int(10) NULL DEFAULT 0 COMMENT '游戏ID',
  `uid` int(10) NULL DEFAULT 0 COMMENT '用户id',
...
CREATE TABLE `wp_event_prizes`  (
  ...
  `prize_list` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '奖品列表',
  `prize_count` int(10) NULL DEFAULT NULL COMMENT '奖品数量',
  `start_num` int(10) NULL DEFAULT 0 COMMENT '开始数字',
...
CREATE TABLE `wp_exchange`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品id',
  `uid` int(10) NULL DEFAULT NULL COMMENT '兑换用户',
  `cTime` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '兑换时间',
  `mobile` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系方式',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系方式',
  `status` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '状态',
...
CREATE TABLE `wp_file`  (
  ...
  `savename` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '保存名称',
...
CREATE TABLE `wp_goods_count`  (
  ...
  `day_time` int(10) NULL DEFAULT NULL COMMENT '格式化时间',
  `time` int(10) NULL DEFAULT NULL COMMENT '时间戳',
  `uid` int(10) NULL DEFAULT NULL COMMENT '访问用户uid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_goods_param_link`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '参数名',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品编号',
...
CREATE TABLE `wp_goods_param_temp`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '模板名称',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
...
CREATE TABLE `wp_haggle`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '活动名称',
  `share_cover` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '分享的宣传图',
  `start_time` int(10) NOT NULL COMMENT '活动开始时间',
  `end_time` int(10) NOT NULL COMMENT '活动结束时间',
  `is_subscribe` tinyint(2) NULL DEFAULT 0 COMMENT '是否需要关注公众号才能参加',
  `is_member` tinyint(2) NULL DEFAULT 0 COMMENT '是否需要成为会员才能参加',
...
CREATE TABLE `wp_haggle_order`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `haggle_id` int(10) NULL DEFAULT NULL COMMENT '活动Id',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户Id',
  `create_at` int(10) NULL DEFAULT NULL COMMENT '参与时间',
  `market_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '商品价格',
  `sale_price` decimal(10, 2) NULL DEFAULT NULL COMMENT '当前价格',
  `member_count` int(10) NULL DEFAULT 0 COMMENT '砍价人数',
...
CREATE TABLE `wp_haggle_user`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `haggle_id` int(10) NULL DEFAULT NULL COMMENT 'haggle_id',
  `invite_uid` int(10) NULL DEFAULT NULL COMMENT '请求帮砍价的用户ID',
  `uid` int(10) NULL DEFAULT NULL COMMENT '砍价人的UID',
  `price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '砍价价格',
  `create_at` int(10) NULL DEFAULT NULL COMMENT '砍价时间',
...
CREATE TABLE `wp_hooks`  (
  ...
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `addons` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '钩子挂载的插件 \'，\'分割',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `搜索索引`(`name`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '插件钩子表' ROW_FORMAT = Compact;
...
CREATE TABLE `wp_join_count`  (
  `follow_id` int(10) NULL DEFAULT NULL,
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `aim_id` int(10) NULL DEFAULT NULL,
  `count` int(10) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fid_aim`(`follow_id`, `aim_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lottery_prize_list`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `sports_id` int(10) NULL DEFAULT NULL COMMENT '活动编号',
  `award_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '奖品编号',
  `award_num` int(10) NULL DEFAULT NULL COMMENT '奖品数量',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `sports_id`(`sports_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lucky_follow`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `draw_id` int(10) NULL DEFAULT NULL COMMENT '活动编号',
  `sport_id` int(10) NULL DEFAULT NULL COMMENT '场次编号',
  `award_id` int(10) NULL DEFAULT NULL COMMENT '奖品编号',
  `follow_id` int(10) NULL DEFAULT NULL COMMENT '粉丝id',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地址',
  `num` int(10) NULL DEFAULT 0 COMMENT '获奖数',
  `state` tinyint(2) NULL DEFAULT 0 COMMENT '兑奖状态',
  `zjtime` int(10) NULL DEFAULT NULL COMMENT '中奖时间',
  `djtime` int(10) NULL DEFAULT NULL COMMENT '兑奖时间',
  `aim_table` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动标识',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备注',
  `scan_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '核销码',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
...
CREATE TABLE `wp_lzwg_activities`  (
  ...
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '活动描述',
  `logo_img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '活动LOGO',
  `start_time` int(10) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` int(10) NULL DEFAULT NULL COMMENT '结束时间',
  `get_prize_tip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '中奖提示信息',
  `no_prize_tip` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '未中奖提示信息',
  `ctime` int(10) NULL DEFAULT NULL COMMENT '活动创建时间',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `lottery_number` int(10) NULL DEFAULT 1 COMMENT '抽奖次数',
  `comment_status` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '评论是否需要审核',
...
CREATE TABLE `wp_lzwg_activities_vote`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `lzwg_id` int(10) NULL DEFAULT NULL COMMENT '活动编号',
  `lzwg_type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '活动类型',
  `vote_id` int(10) NULL DEFAULT NULL COMMENT '题目编号',
  `vote_type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '问题类型',
  `vote_limit` int(10) NULL DEFAULT NULL COMMENT '最多选择几项',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lzwg_coupon`  (
  ...
  `money` decimal(10, 2) NULL DEFAULT NULL COMMENT '减免金额',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '代金券 标题',
  `condition` decimal(10, 2) NULL DEFAULT NULL COMMENT '抵押条件',
  `intro` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '优惠券简述',
  `img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '优惠卷图标',
  `sn_str` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '序列号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lzwg_coupon_receive`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `follow_id` int(10) NULL DEFAULT NULL COMMENT '用户ID',
  `coupon_id` int(10) NULL DEFAULT NULL COMMENT '优惠券ID',
  `sn_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '序列号',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '领取时间',
  `aim_id` int(10) NULL DEFAULT NULL COMMENT '活动编号',
  `aim_table` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动表名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lzwg_coupon_sn`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `coupon_id` int(10) NULL DEFAULT NULL COMMENT '优惠券Id',
  `sn` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '优惠券sn',
...
CREATE TABLE `wp_lzwg_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `lzwg_id` int(10) NULL DEFAULT NULL COMMENT '活动ID',
  `follow_id` int(10) NULL DEFAULT NULL COMMENT '用户ID',
...
CREATE TABLE `wp_lzwg_vote`  (
  ...
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '投票标题',
  `description` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '投票描述',
  `picurl` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '封面图片',
  `type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '选择类型',
  `start_date` int(10) NULL DEFAULT NULL COMMENT '开始日期',
  `end_date` int(10) NULL DEFAULT NULL COMMENT '结束日期',
  `is_img` tinyint(2) NULL DEFAULT 0 COMMENT '文字/图片投票',
  `vote_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '投票数',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '投票创建时间',
  `mTime` int(10) NULL DEFAULT NULL COMMENT '更新时间',
  `template` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'default' COMMENT '素材模板',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `vote_type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '题目类型',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lzwg_vote_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `vote_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '投票ID',
  `user_id` int(10) NULL DEFAULT NULL COMMENT '用户ID',
  `options` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '选择选项',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
  `activity_id` int(10) NULL DEFAULT NULL COMMENT '活动编号',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_lzwg_vote_option`  (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '选项标题',
  `image` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '图片选项',
...
CREATE TABLE `wp_manager`  (
  ...
  `headface_url` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '管理员头像',
  ...
  `website_logo` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '网站LOGO',
...
CREATE TABLE `wp_material_file`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `file_id` int(10) NULL DEFAULT NULL COMMENT '上传文件',
...
CREATE TABLE `wp_material_image`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `cover_id` int(10) NULL DEFAULT NULL COMMENT '图片在本地的ID',
  `cover_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '本地URL',
  `media_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '微信端图文消息素材的media_id',
...
CREATE TABLE `wp_member_erp_buying`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `invoicedate` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT ' 销售日期',
  `tag` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '销售状态',
  `invoiceno` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '销售单号',
  `barcode` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '条码号',
  `partdesc` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '货品描述',
  `price` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '金额',
...
CREATE TABLE `wp_member_follow_link`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '粉丝用户',
  `member_id` int(10) NULL DEFAULT NULL COMMENT '会员',
  `wpid` int(10) NULL DEFAULT NULL COMMENT '公众号id',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '关注时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_menu`  (
  ...
  `target` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '_self' COMMENT '打开方式',
  `is_hide` tinyint(2) NULL DEFAULT 0 COMMENT '是否隐藏',
  `sort` int(10) NULL DEFAULT 0 COMMENT '排序号',
  `place` tinyint(1) NULL DEFAULT 0 COMMENT '0：运营端，1：开发端',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 804 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_message`  (
  ...
  `msgtype` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '消息类型',
  `appmsg_id` int(10) NULL DEFAULT NULL COMMENT '图文id',
  `voice_id` int(10) NULL DEFAULT NULL COMMENT '语音id',
  `video_id` int(10) NULL DEFAULT NULL COMMENT '视频id',
...
INSERT INTO `wp_model` VALUES (1484, 'SignIn_Log', '签到记录', 0, '', 1, NULL, '1:基础', NULL, '', '', '', NULL, 10, 'uid', '', 0, 0, 0, 'MyISAM', 'sing_in');
...
CREATE TABLE `wp_online_count`  (
  `publicid` int(11) NULL DEFAULT NULL,
  `addon` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `aim_id` int(11) NULL DEFAULT NULL,
  `time` bigint(12) NULL DEFAULT NULL,
  `count` int(11) NULL DEFAULT NULL,
  INDEX `tc`(`time`, `count`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_payment_config`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `appid` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `mch_id` char(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `appsecret` char(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `wp_payment_order`  (
  ...
  `aim_id` int(10) NULL DEFAULT NULL COMMENT 'aim_id',
...
CREATE TABLE `wp_payment_set`  (
  ...
  `wx_cert_pem` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '上传证书',
  `wx_key_pem` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '上传密匙',
...
CREATE TABLE `wp_picture`  (
  ...
  `category_id` int(255) NULL DEFAULT 0,
...
CREATE TABLE `wp_picture_category`  (
  ...
  `system` tinyint(2) NULL DEFAULT 0,
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_prize`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `addon` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'Scratch' COMMENT '来源插件',
  `target_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '来源ID',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '奖项标题',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '奖项',
  `num` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '名额数量',
  `sort` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '排序号',
  `img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '奖品图片',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_prize_address`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '奖品收货地址',
  `mobile` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机',
  `turename` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收货人姓名',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户id',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `prizeid` int(10) NULL DEFAULT NULL COMMENT '奖品编号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_qr_admin`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `action_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'QR_SCENE' COMMENT '类型',
...
CREATE TABLE `wp_qr_code`  (
  ...
  `aim_id` int(10) UNSIGNED NOT NULL COMMENT '插件表里的ID值',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
  `action_name` char(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'QR_SCENE' COMMENT '二维码类型',
  `extra_text` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '文本扩展',
  `extra_int` int(10) NULL DEFAULT NULL COMMENT '数字扩展',
  `request_count` int(10) NULL DEFAULT 0 COMMENT '请求数',
...
CREATE TABLE `wp_real_prize`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `prize_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '奖品名称',
  `prize_conditions` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '活动说明',
  `prize_count` int(10) NULL DEFAULT NULL COMMENT '奖品个数',
  `prize_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '上传奖品图片' COMMENT '奖品图片',
  `fail_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '领取失败提示',
  `prize_type` tinyint(2) NULL DEFAULT 1 COMMENT '奖品类型',
  `use_content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '使用说明',
  `prize_title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动标题',
  `template` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'default' COMMENT '素材模板',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_recharge_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `recharge` float NULL DEFAULT NULL COMMENT '充值金额',
...
CREATE TABLE `wp_reservation`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `reservation_date` int(10) NULL DEFAULT NULL COMMENT '日期',
  `morning_count` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '30' COMMENT '上午放号数',
  `afternoon_count` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '30' COMMENT '下午放号数',
  `c_time` int(10) NULL DEFAULT NULL COMMENT '创建日期',
  `manager_id` int(10) NULL DEFAULT 0 COMMENT '管理员ID',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_reservation_number`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `reservation_date` int(10) NULL DEFAULT NULL COMMENT '预约日期',
  `type` int(10) NULL DEFAULT NULL COMMENT '上午/下午',
  `is_use` int(10) NULL DEFAULT 0 COMMENT '是否预约',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '病症描述',
  `use_time` int(10) NULL DEFAULT NULL COMMENT '提交预约的时间',
  `reservation_id` int(10) NULL DEFAULT NULL COMMENT '日期ID',
  `reservation_num` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '预约号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_score_exchange_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `card_score_id` int(10) NULL DEFAULT NULL COMMENT '兑换活动id',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `ctime` int(10) NULL DEFAULT NULL COMMENT 'ctime',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
...
CREATE TABLE `wp_scratch`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `keyword` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '关键词',
  `use_tips` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '使用说明',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `intro` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '封面简介',
  `end_time` int(10) NULL DEFAULT NULL COMMENT '结束时间',
  `cover` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '封面图片',
  `cTime` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '发布时间',
  `start_time` int(10) NULL DEFAULT NULL COMMENT '开始时间',
  `end_tips` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '过期说明',
  ...
  `end_img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '过期提示图片',
  `template` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'default' COMMENT '素材模板',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_seckill_order`  (
  ...
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `create_at` int(10) NULL DEFAULT NULL COMMENT '秒杀时间',
  `sale_price` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '秒杀价格',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品ID',
  `shop_goods_id` int(10) NULL DEFAULT NULL COMMENT '库存ID',
  `is_pay` tinyint(2) NULL DEFAULT 0 COMMENT ' 状态',
...
CREATE TABLE `wp_servicer`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户选择',
...
CREATE TABLE `wp_share_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户id',
  `sTime` int(10) NULL DEFAULT NULL COMMENT '分享时间',
...
CREATE TABLE `wp_shop`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商店名称',
  `logo` int(10) NULL DEFAULT NULL COMMENT '商店LOGO',
  `intro` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '店铺简介',
  `mobile` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系电话',
  `qq` int(10) NULL DEFAULT NULL COMMENT 'QQ',
  ...
  `gps` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'GPS经纬度',
  `custom_tip` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '联系客服提示内容',
...
CREATE TABLE `wp_shop_address`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户ID',
  `truename` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '收货人姓名',
...
CREATE TABLE `wp_shop_attribute`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `is_show` tinyint(2) NULL DEFAULT 1 COMMENT '是否显示',
  `cate_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '所属分类ID',
  `error_info` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '出错提示',
  `sort` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '排序号',
  `validate_rule` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '正则验证',
  `is_must` tinyint(2) NULL DEFAULT NULL COMMENT '是否必填',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '字段备注',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '默认值',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '字段标题',
  `mTime` int(10) NULL DEFAULT NULL COMMENT '修改时间',
  `extra` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '参数',
  `attr_type` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'string' COMMENT '字段类型',
  `type` tinyint(2) NULL DEFAULT 0 COMMENT '属性类型',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '属性标识',
  `goods_field` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品表中所占用的字段名',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_cart`  (
  ...
  `num` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '数量',
  `price` decimal(10, 2) NULL DEFAULT NULL COMMENT '单价',
  `goods_type` tinyint(2) NULL DEFAULT 0 COMMENT '商品类型',
  `openid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'openid',
  `spec_option_ids` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品SKU',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `wp_shop_cashout_account`  (
  ...
  `type` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提现方式',
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '姓名',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_shop_cashout_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `cashout_amount` float NULL DEFAULT NULL COMMENT '提现金额',
  `remark` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '备注',
  `cashout_account` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '提现账号',
  `cashout_status` int(10) NULL DEFAULT 0 COMMENT '提现处理状态',
  `ctime` int(10) NULL DEFAULT NULL COMMENT '提现时间',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_collect`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '使用UID',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品ID',
...
CREATE TABLE `wp_shop_distribution_profit`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'Uid',
  `ctime` int(10) NULL DEFAULT NULL COMMENT '返利时间',
  `profit` float NULL DEFAULT 0 COMMENT '拥金',
  `profit_shop` int(10) NULL DEFAULT NULL COMMENT '获得佣金的店铺',
  `distribution_percent` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分销比例',
  `order_id` int(10) NULL DEFAULT NULL COMMENT '订单id',
  `upper_user` int(10) NULL DEFAULT NULL COMMENT '分销用户',
  `upper_level` int(10) NULL DEFAULT NULL COMMENT '分销用户级别',
  `duser` int(10) NULL DEFAULT NULL COMMENT '该用户带来的消费用户',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_distribution_user`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户id',
  `enable` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '是否启用',
  `branch_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '授权门店',
  `ctime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `qr_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '二维码',
  `fans_gift_money` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '转发增粉奖励金额',
  ...
  `inviter` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邀请人',
  `level` int(10) NULL DEFAULT NULL COMMENT '分佣级别',
  `is_audit` int(10) NULL DEFAULT 0 COMMENT '是否审核',
  `is_delete` int(10) NULL DEFAULT 0 COMMENT '是否删除',
  `shop_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商城店名字',
  `shop_logo` varchar(300) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商城图标',
  `profit_money` float NULL DEFAULT 0 COMMENT '盈利金额',
  `zfb_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付宝名称',
  `zfb_account` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '支付宝账号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_goods`  (
  ...
  `cover` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '商品封面图',
  `imgs` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品图片',
  ...
  `category_id` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品分类',
  `auto_send` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '自动发货',
  `virtual_textarea` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '虚拟物品信息',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `weight` float NULL DEFAULT NULL COMMENT '重量',
  `sn_code` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商品编号',
  ...
  `file_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文件下载链接',
  `express` decimal(10, 2) NULL DEFAULT 0.00 COMMENT '邮费',
  `send_type` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '1' COMMENT '收货方式',
  `stores_ids` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '自提门店',
  `is_all_store` tinyint(2) NULL DEFAULT 0 COMMENT '店门类型',
...
CREATE TABLE `wp_shop_goods_comment`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品编号',
  `score` int(10) NULL DEFAULT 0 COMMENT '评价',
  `content` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '内容',
  `order_id` int(10) NULL DEFAULT NULL COMMENT '订单编号',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户uid',
...
CREATE TABLE `wp_shop_goods_sku_config`  (
  ...
  `img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '属性加图',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_goods_sku_data`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品ID',
  `cost_price` decimal(11, 2) NULL DEFAULT 0.00 COMMENT '成本价',
  `market_price` decimal(11, 2) NULL DEFAULT 0.00 COMMENT '市场价',
  `sale_price` decimal(11, 2) NULL DEFAULT 0.00 COMMENT '促销价',
  `stock_num` int(10) NULL DEFAULT 0 COMMENT '库存量',
  `sn_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '商品编号',
  ...
  `sku_varchar_0` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文本规格0',
  `sku_varchar_1` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文本规格1',
  `sku_varchar_2` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '文本规格2',
  `spec_option_ids` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '规格属性ID串',
  `lock_num` int(10) NULL DEFAULT 0 COMMENT '商品锁定库存',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_goods_stock`  (
  ...
  `stock` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '物理库存',
  `stock_active` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '销售库存',
  `lock_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '锁定库存',
  `sale_count` int(10) UNSIGNED NULL DEFAULT 0 COMMENT '销售量',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT '商品ID',
...
CREATE TABLE `wp_shop_membership`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `membership` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '会员名',
  `condition` int(10) NULL DEFAULT 0 COMMENT '升级会员条件',
  `uid` int(10) NULL DEFAULT NULL COMMENT '企业用户id',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '图标',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_order`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `goods_datas` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品序列化数据',
  `uid` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  ...
  `address_id` int(10) NULL DEFAULT NULL COMMENT '配送信息',
  `is_send` int(10) NULL DEFAULT 0 COMMENT '是否发货',
  `send_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '快递公司编号',
  `send_number` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '快递单号',
  `send_type` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '发货类型',
  `is_new` tinyint(2) NULL DEFAULT 1 COMMENT '是否为新订单',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `status_code` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '订单跟踪状态码',
  `event_type` tinyint(2) NULL DEFAULT 0 COMMENT '订单来源',
  `is_lock` int(10) NULL DEFAULT 1 COMMENT '数量是否锁定',
  `erp_lock_code` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT 'ERP锁定商品编号',
  `mail_money` float NULL DEFAULT 0 COMMENT '邮费金额',
  `stores_id` int(10) NULL DEFAULT NULL COMMENT '门店编号',
  `pay_time` int(10) NULL DEFAULT NULL COMMENT '支付时间',
  `send_time` int(10) NULL DEFAULT NULL COMMENT '发货时间',
  `extra` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '扩展参数',
...
CREATE TABLE `wp_shop_order_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `order_id` int(10) NULL DEFAULT NULL COMMENT '订单ID',
  `status_code` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '状态码',
...
CREATE TABLE `wp_shop_page`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '页面名称',
  `ctime` int(15) NULL DEFAULT NULL COMMENT '创建时间',
  `config` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '配置参数',
  `desc` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '描述',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `manager_id` int(10) NULL DEFAULT NULL COMMENT '创建者ID',
  `use` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'page' COMMENT '哪里使用',
...
CREATE TABLE `wp_shop_reward`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动名称',
  `start_time` int(10) NULL DEFAULT NULL COMMENT '开始时间',
  `end_time` int(10) NULL DEFAULT NULL COMMENT '过期时间',
  `is_mult` tinyint(2) NULL DEFAULT 0 COMMENT '多级优惠',
  `is_all_goods` tinyint(2) NULL DEFAULT 0 COMMENT '适用的活动商品',
  `goods_ids` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '指定商品ID串',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `manager_id` int(10) NULL DEFAULT NULL COMMENT '管理员ID',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_shop_reward_condition`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `condition` decimal(11, 2) NULL DEFAULT NULL COMMENT '条件',
  `reward_id` int(10) NULL DEFAULT NULL COMMENT '活动ID',
  `money` decimal(10, 2) NULL DEFAULT NULL COMMENT '现在开关',
  `money_param` decimal(10, 2) NULL DEFAULT NULL COMMENT '现金参数',
  `postage` tinyint(2) NULL DEFAULT 0 COMMENT '免邮',
  `score` tinyint(2) NULL DEFAULT 0 COMMENT '积分开关',
  `score_param` int(10) NULL DEFAULT NULL COMMENT '积分参数',
  `coupon` tinyint(2) NULL DEFAULT 0 COMMENT '优惠券开关',
  `coupon_param` int(10) NULL DEFAULT NULL COMMENT '优惠券ID',
  `sort` int(10) NULL DEFAULT 0 COMMENT '排序号',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_service`  (
  ...
  `is_manager` int(10) NULL DEFAULT 0 COMMENT '是否管理员回复',
  `from_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0_导航栏' COMMENT '入口类型',
...
CREATE TABLE `wp_shop_spec`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '规格名称',
  `remark` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '备注',
  `spec_sort` int(10) NULL DEFAULT 0 COMMENT '排序',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户ID',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_statistics_follow`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT '粉丝id',
  `duid` int(10) NULL DEFAULT NULL COMMENT '分销用户id',
  `ctime` int(10) NULL DEFAULT NULL COMMENT '关注时间',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `openid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '粉丝openid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_track`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `goods_id` int(10) NULL DEFAULT NULL COMMENT 'goods_id',
...
CREATE TABLE `wp_shop_user_level_link`  (
  ...
  `cTime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `uid` int(10) NULL DEFAULT NULL COMMENT '分销用户',
  `upper_user` int(10) NULL DEFAULT NULL COMMENT '上级分销用户',
  `level` int(10) NULL DEFAULT NULL COMMENT '分销级别',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_shop_value`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `cate_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '所属分类ID',
  `value` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '表单值',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '增加时间',
  `openid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'OpenId',
  `uid` int(10) NULL DEFAULT NULL COMMENT '用户ID',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_shop_virtual`  (
  ...
  `is_use` char(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '0' COMMENT '是否已经使用',
  `order_id` int(10) NULL DEFAULT NULL COMMENT '订单号',
  `card_codes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '点卡序列号',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'wpid',
  `uid` int(10) NULL DEFAULT NULL COMMENT '购买用户uid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_sms`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `from_type` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '用途',
  `code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '验证码',
  `smsId` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '短信唯一标识',
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '手机号',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `wp_sn_code`  (
  ...
  `target_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '来源ID',
  `prize_id` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '奖项ID',
...
CREATE TABLE `wp_sport_award`  (
  ...
  `uid` int(10) NULL DEFAULT NULL COMMENT 'uid',
  `coupon_id` char(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '选择赠送券',
  `money` decimal(10, 2) NULL DEFAULT NULL COMMENT '返现金额',
  `aim_table` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '活动标识',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_staff_follow_link`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `uid` int(10) NULL DEFAULT 0 COMMENT '粉丝用户',
  `staff_id` int(10) NULL DEFAULT 0 COMMENT '员工',
  `wpid` int(10) NULL DEFAULT 0 COMMENT '公众号id',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '关注时间',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_stores`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '店名',
  `address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '详细地址',
  `phone` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '联系电话',
  `gps` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT 'GPS经纬度',
  `coupon_id` int(10) NULL DEFAULT NULL COMMENT '所属优惠券编号',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'token',
  `open_time` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '营业时间',
  `img` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '门店展示图',
  `auth_group` int(10) NULL DEFAULT NULL COMMENT '门店用户组',
  `shop_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '地点编码',
...
CREATE TABLE `wp_stores_link`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `coupon_id` int(10) NULL DEFAULT NULL COMMENT 'coupon_id',
  `wpid` int(10) NULL DEFAULT NULL COMMENT 'shop_id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `wp_update_score_log`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `score` int(10) NULL DEFAULT NULL COMMENT '修改积分',
  `branch_id` int(10) NULL DEFAULT NULL COMMENT '修改门店',
  `operator` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '操作员',
  `cTime` int(10) NULL DEFAULT NULL COMMENT '修改时间',
  `member_id` int(10) NULL DEFAULT NULL COMMENT '会员卡id',
  `manager_id` int(10) NULL DEFAULT NULL COMMENT '管理员id',
  `wpid` int(10) NOT NULL DEFAULT 0 COMMENT 'wpid',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `wp_update_version`  (
  ...
  `create_date` int(10) NULL DEFAULT NULL COMMENT '创建时间',
...
CREATE TABLE `wp_weisite_category`  (
  ...
  `icon` int(10) UNSIGNED NULL DEFAULT NULL COMMENT '分类图片',
  `url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '外链',
